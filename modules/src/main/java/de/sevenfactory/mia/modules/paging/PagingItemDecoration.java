...
class PagingItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public PagingItemDecoration(int horizontalMargin, int verticalMargin, boolean useHorizontalMarginOnEdges, boolean useVerticalMarginOnEdges, int initialColumnCount) {
